...
export function CLIC({
  ...
  return (
    ...
    >
      ...
      >
        <svg viewBox="0 0 138 138" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div className={cn("flex-shrink-0", sizeClasses[size])}>
        <svg viewBox="0 0 65 138" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M27.6072 0.501282H0.196533V110.381V137.85H27.6072H64.1563V110.381H27.6072V0.501282Z" fill={color} />
        </svg>
      </div>

      {/* I - Static */}
      <div className={cn("flex-shrink-0", sizeClasses[size])}>
        <svg viewBox="0 0 29 142" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M28.2152 0.849976H0.230469V141.061H28.2152V0.849976Z" fill={color} />
        </svg>
      </div>
