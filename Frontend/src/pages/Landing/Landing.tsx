...
export default function Landing() {
  ...
  return (
    <div>
<Marquee autoFill={true} speed={200} className="bg-[#AA3EEE] py-5">
  <img src={img_1} className="mx-10 w-70" />
</Marquee>
<Marquee autoFill={true} speed={200} className="bg-[#0024F8] py-5" direction="right">
  <img src={img_2} className="mx-10 w-70" />
</Marquee>
<Marquee autoFill={true} speed={200} className="bg-[#FF16D0] py-5">
  <img src={img_1} className="mx-10 w-70" />
</Marquee>
