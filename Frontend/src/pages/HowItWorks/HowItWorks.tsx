    ...
    <section className="py-12 px-4 sm:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <article className="">
          ...
          <p className="text-2xl">
            The pools are live, online and require you to turn on your video
            camera. In a series of short video dates, you'll speak to members we
            select for that pool. Connect from the inside out, through
            conversation, and not the outside in, based on photos.
          </p>
          <br />
          <hr className="border-black" />
          <br />
          ...
          <p className="text-2xl">
            You can download the app after you sign up for membership or
          ...
          <p className="text-2xl">
            ...
            presenting members for you to video-date.
          </p>
          <br />
          <hr className="border-black" />
          <br />
          ...
          <p className="text-2xl">
            Each video date and pool has a fixed duration. If you Clic with your
            date, you'll have the option to extend it. If they also Clic'd with
            you, the date will be extended. But remember that each extension
            could reduce the time available to speak to others in the pool.
          </p>
          <br />
          <hr className="border-black" />
          <br />
          ...
          <p className="text-2xl">
            As we work on improving your experience, we would love to hear your
            thoughts. Please complete the short feedback form after each date.
          </p>
          <br />
          {/* <hr className="border-black" /> */}
          <br />
